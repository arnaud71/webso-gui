  ...
  .controller('ValidationListCtrl', function ($cookieStore, $scope, $resource, cfg, $modal, $filter, sharedService) {
    ...
    $scope.gridOptionsSource = {
      ...
      columnDefs: [
        ...
        {width:'100px',field:'importance_i', displayName:  $filter('i18n')('_IMPORTANCE_'), cellTemplate: '<div class="ngCellText" ng-bind-html="{{row.getProperty(col.field)}}"></div>'}, //'{{row.getProperty(col.field)}}'},//' | importanceView}}'},
